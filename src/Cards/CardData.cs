...
public class CardData
{
    ...
    public string Type { get; set; } = string.Empty; // 枚举：Attack、Defense、Seed、Infection
    public int Cost { get; set; }                    // 打出该牌消耗的能量
    public int CopyCount { get; set; } = 1;         // 该卡在对应牌组中的张数
    public string TargetType { get; set; } = string.Empty; // 枚举：Enemy、Grid_Empty、Grid_Any、Grid_UninfectedCenter
